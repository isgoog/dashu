...
enum Spells
{
    ...
    // Phase 4 spells
    SPELL_FIREBALL                      = 36805,//火球术
    SPELL_ARCANE_DISRUPTION             = 36834,//奥术干扰
    SPELL_PHOENIX                       = 36723,
    SPELL_MIND_CONTROL                  = 36797,//精神控制
    SPELL_SHOCK_BARRIER                 = 36815,//护盾
    SPELL_PYROBLAST                     = 36819,//炎爆术
    SPELL_FLAME_STRIKE                  = 36735,
    SPELL_FLAME_STRIKE_DAMAGE           = 36731,//烈焰风暴
