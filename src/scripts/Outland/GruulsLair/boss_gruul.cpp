    ...
    public:
        ...
        struct boss_gruulAI : public BossAI
        {
            ...
            void Reset()
            {
                _Reset();
                _caveInTimer = 29000;
				me->CastSpell(me, 934015, true);
				me->CastSpell(me, 934016, true);
				me->CastSpell(me, 934017, true);
            }
			...
			void DamageTaken(Unit*, uint32& damage, DamageEffectType, SpellSchoolMask)
			{
				...
				{
					if (me->HasAura(934016))
					{
						me->CastSpell(me, 23965, false);
						me->RemoveAurasDueToSpell(934016);
					}
					else if (me->HasAura(934017))
					{
						me->CastSpell(me, 23965, false);
						me->RemoveAurasDueToSpell(934017);
					}
