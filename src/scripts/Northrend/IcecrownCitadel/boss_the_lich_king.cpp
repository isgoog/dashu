    ...
    public:
        ...
        struct boss_the_lich_kingAI : public BossAI
        {
            ...
            void EnterCombat(Unit* target)
            {
				...
				me->CastSpell(me, 937001, true);
				if (sObjectMgr->isBossCoreA(me->GetMap()->GetInstanceId()) == 1)
					me->CastSpell(me, 937001, true);
				else if (sObjectMgr->isBossCoreA(me->GetMap()->GetInstanceId()) == 2)
					me->CastSpell(me, 937002, true);
				else if (sObjectMgr->isBossCoreA(me->GetMap()->GetInstanceId()) == 3)
					me->CastSpell(me, 937003, true);
				else if (sObjectMgr->isBossCoreA(me->GetMap()->GetInstanceId()) == 4)
					me->CastSpell(me, 937004, true);
				else if (sObjectMgr->isBossCoreA(me->GetMap()->GetInstanceId()) == 5)
					me->CastSpell(me, 937005, true);
				else if (sObjectMgr->isBossCoreA(me->GetMap()->GetInstanceId()) == 6)
					me->CastSpell(me, 937006, true);
				else if (sObjectMgr->isBossCoreA(me->GetMap()->GetInstanceId()) == 7)
					me->CastSpell(me, 937007, true);
				else if (sObjectMgr->isBossCoreA(me->GetMap()->GetInstanceId()) == 8)
					me->CastSpell(me, 937008, true);
				else if (sObjectMgr->isBossCoreA(me->GetMap()->GetInstanceId()) == 9)
					me->CastSpell(me, 937009, true);
				else if (sObjectMgr->isBossCoreA(me->GetMap()->GetInstanceId()) == 10)
					me->CastSpell(me, 937010, true);
            }
            ...
            void UpdateAI(uint32 diff)
            {
                ...
                switch (uint32 eventId = events.ExecuteEvent())
                {
                    ...
                    case EVENT_QUAKE:
                        ...
                        //events.ScheduleEvent(EVENT_SUMMON_VALKYR, 15000, EVENT_GROUP_ABILITIES);wqcore¹Ø±ÕÕÙ»½Íß¶ûÆ÷
