...
enum eEvents
{
	...
	EVENT_SUMMON_NPC,
	EVENT_SUMMON_NPC_TONGTIAN,
	EVENT_SUMMON_NPC_ZHAOHUAN1,
	EVENT_SUMMON_NPC_ZHAOHUAN2,
	EVENT_JISHI_TONGTIAN,
	EVENT_KAIMEN,
	EVENT_GUANMEN,
};
...
enum euiWorldStates
{
	UPDATE_STATE_UI_SHIJIAN = 6002,
	UPDATE_STATE_UI_SHIJIAN_COUNT = 6003,
	UPDATE_STATE_UI_BOSHU = 6000,
	UPDATE_STATE_UI_BOSHU_COUNT = 6001,
	UPDATE_STATE_UI_JIFEN = 6004,
	UPDATE_STATE_UI_JIFEN_COUNT = 6005,
};
