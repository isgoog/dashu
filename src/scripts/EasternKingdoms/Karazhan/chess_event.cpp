...
#define GOSSIP_ITEM_ORC_GRUNT           "控制兽人步兵"
#define GOSSIP_ITEM_ORC_WOLF            "控制兽人座狼"
#define GOSSIP_ITEM_SUMMONED_DEAMON     "控制被召唤的恶魔"
#define GOSSIP_ITEM_ORC_WARLOCK         "控制兽人术士"
#define GOSSIP_ITEM_ORC_NECROLYTE       "控制兽人通灵师"
#define GOSSIP_ITEM_WARCHIEF_BLACKHAND  "控制黑手酋长"
#define GOSSIP_ITEM_HUMAN_FOOTMAN       "控制人类步兵"
#define GOSSIP_ITEM_HUMAN_CHARGER       "控制人类骑兵"
#define GOSSIP_ITEM_WATER_ELEMENTAL     "控制被召唤的水元素"
#define GOSSIP_ITEM_HUMAN_CONJURER      "控制人类召唤师"
#define GOSSIP_ITEM_HUMAN_CLERIC        "控制人类祭司"
#define GOSSIP_ITEM_KING_LLANE          "控制莱恩国王"
#define GOSSIP_ITEM_RESET_BOARD         "重置"
...
public:
    ...
    struct npc_echo_of_medivhAI : public ScriptedAI
    {
		...
		void DoAction(int32 const eventType) override
        {
            ...
            {
				sLog->outCommand(123, "maidiwenchufa");
                events.Reset();
        ...
        {
            if (!instance || instance->GetData(DATA_CHESS) != IN_PROGRESS)
                return;

            events.Update(diff);
			//sLog->outCommand(123, "maidiwenchufaai");
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    case EVENT_CHEAT_CHECK_1:
                    {
                        ...
                        {
							DoCast(me, instance->GetData(DATA_TEAM_IN_INSTANCE) == TEAM_ALLIANCE ? SPELL_HAND_OF_MEDIVH_HORDE : SPELL_HAND_OF_MEDIVH_ALLIANCE);
							sLog->outCommand(123, "chufa1");
                            Talk(TALK_CHEAT);
                    ...
                    case EVENT_CHEAT_CHECK_2:
                    {
                        ...
                        {
							DoCast(me, instance->GetData(DATA_TEAM_IN_INSTANCE) == TEAM_ALLIANCE ? SPELL_FURY_OF_MEDIVH_ALLIANCE : SPELL_FURY_OF_MEDIVH_HORDE);
							sLog->outCommand(123, "chufa2");
                            Talk(TALK_CHEAT);
                    ...
                    case EVENT_CHEAT_CHECK_3:
                    {
                        ...
                        {
							DoCast(me, instance->GetData(DATA_TEAM_IN_INSTANCE) == TEAM_ALLIANCE ? SPELL_FULL_HEAL_HORDE : SPELL_FULL_HEAL_ALLIANCE);
							sLog->outCommand(123, "chufa3");
                            // heal part
                            Talk(TALK_CHEAT);
    ...
    bool OnGossipHello(Player* player, Creature* creature)
    {
        ...
        if (!instance)
            return false;
        if (instance->GetData(DATA_CHESS) == SPECIAL)
    ...
    bool OnGossipSelect(Player* player, Creature* creature, uint32 /*sender*/, uint32 action)
    {
        ...
        switch (action)
        {
            case GOSSIP_ACTION_INFO_DEF + 1:
                ...
                else if (instance->GetData(DATA_CHESS) == DONE)
...
public:
    ...
    void Reset()
    {
		...
		if (!((instance->GetData(DATA_TEAM_IN_INSTANCE) == TEAM_ALLIANCE && m_faction == FACTION_ID_CHESS_ALLIANCE) ||
			(instance->GetData(DATA_TEAM_IN_INSTANCE) == TEAM_HORDE && m_faction == FACTION_ID_CHESS_HORDE) ||
              instance->GetData(DATA_CHESS) == DONE))
	...
	void DamageTaken(Unit* doneBy, uint32& damage, DamageEffectType /*damagetype*/, SpellSchoolMask /*damageSchoolMask*/)
    {
        switch (me->GetEntry())
        {
            case NPC_ORC_GRUNT:
            ...
            case NPC_WARCHIEF_BLACKHAND:
				if (instance->GetData(DATA_TEAM_IN_INSTANCE) == TEAM_ALLIANCE)
					instance->SetData(DATA_CHESS_DAMAGE, damage);
                break;
            ...
            case NPC_KING_LLANE:
				if (instance->GetData(DATA_TEAM_IN_INSTANCE) == TEAM_HORDE)
					instance->SetData(DATA_CHESS_DAMAGE, damage);
                break;
        }
    }
...
public:
    ...
    struct npc_king_llaneAI : public npc_chess_piece_genericAI
    {
		...
		void DamageTaken(Unit* doneBy, uint32& damage, DamageEffectType a, SpellSchoolMask b) 
        {
			npc_chess_piece_genericAI::DamageTaken(doneBy, damage,a,b);

			if (!damage || !m_bIsAttacked || !instance || doneBy->GetTypeId() != TYPEID_UNIT)
                return;
        ...
        void JustDied(Unit* pKiller) override
        {
            ...
            else
            {
				if (instance->GetData(DATA_TEAM_IN_INSTANCE) == TEAM_HORDE)
                {
                    Talk(TALK_PLAYER_LOOSE_PIECE_CHECKMATE);
                    instance->SetData(DATA_CHESS, DONE);
                }
                else
                {
                    Talk(TALK_MEDHIV_LOOSE_PIECE_CHECKMATE);
                    instance->SetData(DATA_CHESS, FAIL);
                }
            }
    ...
    bool OnGossipHello(Player* player, Creature* creature)
    {
		...
		if ((instance->GetData(DATA_CHESS) != DONE && player->GetTeamId() == TEAM_ALLIANCE) || ((instance_karazhan::instance_karazhan_InstanceMapScript *)instance)->IsFriendlyGameReady())
...
public:
    ...
    bool OnGossipHello(Player* player, Creature* creature)
    {
		...
		if (instance->GetData(DATA_CHESS) != DONE && player->GetTeamId() == TEAM_HORDE || ((instance_karazhan::instance_karazhan_InstanceMapScript *)instance)->IsFriendlyGameReady())
...
public:
    ...
    struct npc_human_conjurerAI : public npc_chess_piece_genericAI
    {
        ...
        void SpellHit(Unit* pCaster, SpellInfo const* pSpell) override { npc_chess_piece_genericAI::SpellHit(pCaster, pSpell); }
		void UpdateAI(const uint32 diff) override { npc_chess_piece_genericAI::UpdateAI(diff); }
		void DamageTaken(Unit* doneBy, uint32& damage, DamageEffectType a, SpellSchoolMask b) override { npc_chess_piece_genericAI::DamageTaken(doneBy, damage,a,b); }
        ...
        void JustDied(Unit* pKiller) override
        {
			...
			((instance_karazhan::instance_karazhan_InstanceMapScript *)instance)->DoMoveChessPieceToSides(SPELL_TRANSFORM_CONJURER, FACTION_ID_CHESS_ALLIANCE, false);
        }
    ...
    bool OnGossipHello(Player* player, Creature* creature)
    {
		...
		if ((instance->GetData(DATA_CHESS) == IN_PROGRESS && player->GetTeamId() == TEAM_ALLIANCE) || instance->GetData(DATA_CHESS) == SPECIAL)
...
public:
    ...
    struct npc_orc_warlockAI : public npc_chess_piece_genericAI
    {
        ...
        void SpellHit(Unit* pCaster, SpellInfo const* pSpell) override { npc_chess_piece_genericAI::SpellHit(pCaster, pSpell); }
		void UpdateAI(const uint32 diff) override { npc_chess_piece_genericAI::UpdateAI(diff); }
		void DamageTaken(Unit* done_by, uint32 &damage, DamageEffectType a, SpellSchoolMask b) { npc_chess_piece_genericAI::DamageTaken(done_by, damage,a,b); }
        ...
        void JustDied(Unit* pKiller) override
        {
			...
			((instance_karazhan::instance_karazhan_InstanceMapScript *)instance)->DoMoveChessPieceToSides(SPELL_TRANSFORM_WARLOCK, FACTION_ID_CHESS_HORDE,false);
        }
    ...
    bool OnGossipHello(Player* player, Creature* creature)
    {
		...
		if ((instance->GetData(DATA_CHESS) == IN_PROGRESS && player->GetTeamId() == TEAM_HORDE) || instance->GetData(DATA_CHESS) == SPECIAL)
...
public:
    ...
    struct npc_human_footmanAI : public npc_chess_piece_genericAI
    {
        ...
        void SpellHit(Unit* pCaster, SpellInfo const* pSpell) override { npc_chess_piece_genericAI::SpellHit(pCaster, pSpell); }
		void UpdateAI(const uint32 diff) override { npc_chess_piece_genericAI::UpdateAI(diff); }
		void DamageTaken(Unit* doneBy, uint32& damage, DamageEffectType a, SpellSchoolMask b) { npc_chess_piece_genericAI::DamageTaken(doneBy, damage,a,b); }
        ...
        void JustDied(Unit* pKiller) override
        {
			...
			((instance_karazhan::instance_karazhan_InstanceMapScript *)instance)->DoMoveChessPieceToSides(SPELL_TRANSFORM_FOOTMAN, FACTION_ID_CHESS_ALLIANCE, false);
        }
...
public:
    ...
    struct npc_orc_gruntAI : public npc_chess_piece_genericAI
    {
        ...
        void JustDied(Unit* pKiller) override
        {
			...
			((instance_karazhan::instance_karazhan_InstanceMapScript *)instance)->DoMoveChessPieceToSides(SPELL_TRANSFORM_GRUNT, FACTION_ID_CHESS_HORDE, false);
        }
...
class npc_water_elemental1 : public CreatureScript, PieceGen
{
public:
    npc_water_elemental1() : CreatureScript("npc_water_elemental1") { }
    ...
    struct npc_water_elementalAI : public npc_chess_piece_genericAI
    {
        ...
        void JustDied(Unit* pKiller) override
        {
			...
			((instance_karazhan::instance_karazhan_InstanceMapScript *)instance)->DoMoveChessPieceToSides(SPELL_TRANSFORM_WATER_ELEM, FACTION_ID_CHESS_ALLIANCE, false);
        }
...
public:
    ...
    struct npc_summoned_daemonAI : public npc_chess_piece_genericAI
    {
        ...
        void JustDied(Unit* pKiller) override
        {
			...
			((instance_karazhan::instance_karazhan_InstanceMapScript *)instance)->DoMoveChessPieceToSides(SPELL_TRANSFORM_DAEMON, FACTION_ID_CHESS_HORDE, false);
        }
...
public:
    ...
    struct npc_human_chargerAI : public npc_chess_piece_genericAI
    {
        ...
        void JustDied(Unit* pKiller) override
        {
			...
			((instance_karazhan::instance_karazhan_InstanceMapScript *)instance)->DoMoveChessPieceToSides(SPELL_TRANSFORM_CHARGER, FACTION_ID_CHESS_ALLIANCE, false);
        }
...
public:
    ...
    struct npc_orc_wolfAI : public npc_chess_piece_genericAI
    {
        ...
        void JustDied(Unit* pKiller) override
        {
			...
			((instance_karazhan::instance_karazhan_InstanceMapScript *)instance)->DoMoveChessPieceToSides(SPELL_TRANSFORM_WOLF, FACTION_ID_CHESS_HORDE, false);
        }
...
public:
    ...
    struct npc_human_clericAI : public npc_chess_piece_genericAI
    {
        ...
        void JustDied(Unit* pKiller) override
        {
			...
			((instance_karazhan::instance_karazhan_InstanceMapScript *)instance)->DoMoveChessPieceToSides(SPELL_TRANSFORM_CLERIC, FACTION_ID_CHESS_ALLIANCE, false);
        }
...
public:
    ...
    struct npc_orc_necrolyteAI : public npc_chess_piece_genericAI
    {
        ...
        void JustDied(Unit* pKiller) override
        {
			...
			((instance_karazhan::instance_karazhan_InstanceMapScript *)instance)->DoMoveChessPieceToSides(SPELL_TRANSFORM_NECROLYTE, FACTION_ID_CHESS_HORDE, false);
        }
