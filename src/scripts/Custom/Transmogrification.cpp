...
const char * Transmogrification::GetSlotName(uint8 slot, WorldSession* session) const
{
	...
	case EQUIPMENT_SLOT_SHOULDERS: return  ("肩膀");// session->GetTrinityString(LANG_SLOT_NAME_SHOULDERS);;
	case EQUIPMENT_SLOT_BODY: return  ("衬衫");// session->GetTrinityString(LANG_SLOT_NAME_BODY);
	...
	case EQUIPMENT_SLOT_HANDS: return  ("手");// session->GetTrinityString(LANG_SLOT_NAME_HANDS);
...
void Transmogrification::LoadConfig(bool reload)
{
	...
	EnableTransmogInfo = sConfigMgr->GetFloatDefault("Transmogrification.EnableTransmogInfo", true);
	...
	CopperCost = sConfigMgr->GetFloatDefault("Transmogrification.CopperCost", 0);

	RequireToken = sConfigMgr->GetFloatDefault("Transmogrification.RequireToken", false);
	TokenEntry = uint32(sConfigMgr->GetFloatDefault("Transmogrification.TokenEntry", 49426));
	TokenAmount = uint32(sConfigMgr->GetFloatDefault("Transmogrification.TokenAmount", 1));

	AllowPoor = sConfigMgr->GetFloatDefault("Transmogrification.AllowPoor", false);
	AllowCommon = sConfigMgr->GetFloatDefault("Transmogrification.AllowCommon", false);
	AllowUncommon = sConfigMgr->GetFloatDefault("Transmogrification.AllowUncommon", true);
	AllowRare = sConfigMgr->GetFloatDefault("Transmogrification.AllowRare", true);
	AllowEpic = sConfigMgr->GetFloatDefault("Transmogrification.AllowEpic", true);
	AllowLegendary = sConfigMgr->GetFloatDefault("Transmogrification.AllowLegendary", false);
	AllowArtifact = sConfigMgr->GetFloatDefault("Transmogrification.AllowArtifact", false);
	AllowHeirloom = sConfigMgr->GetFloatDefault("Transmogrification.AllowHeirloom", true);

	AllowMixedArmorTypes = sConfigMgr->GetFloatDefault("Transmogrification.AllowMixedArmorTypes", false);
	AllowMixedWeaponTypes = sConfigMgr->GetFloatDefault("Transmogrification.AllowMixedWeaponTypes", false);
