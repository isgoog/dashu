...
template<class TMap> class MapScript : public UpdatableScript<TMap>
{
    ...
    public:
        ...
        // Called when a player leaves the map.//玩家离开副本
...
class ItemScript : public ScriptObject
{
    ...
    public:
		...
		virtual bool OnGossipSelect1(Player* player, Item* item, uint32 uiSender, uint32 uiAction)
		{
			return false;
		}//wqcore
...
class ScriptMgr
{
    ...
    public: /* ItemScript */
		...
		bool OnGossipSelectCode1(Player* player, Item* item, uint32 sender, uint32 action, const char* code);//wqcore
