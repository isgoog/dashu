...
void WorldSession::HandleBattlemasterJoinOpcode(WorldPacket & recvData)
{
	...
	if (joinAsGroup && sWorld->getBoolConfig(CROSSFACTION_SYSTEM_BATTLEGROUNDS))
		 return;
	...
	if (sWorld->getBoolConfig(BATTLEGROUNDS_ON))
	{
		if (!sObjectMgr->CheckEnterBattleground(_player, bgTypeId_))
			return;
	}
