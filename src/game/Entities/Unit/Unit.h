...
class Unit : public WorldObject
{
    public:
		...
		uint32 GetPlayerJfypoint(uint8 lx)
		{
			return fypoint[lx];
		}//wqcore
		uint32 GetJntp()
		...
		bool SetCharmedBy1(Unit* charmer, CharmType type, AuraApplication const* aurApp = NULL);
		...
		uint32 fypoint[10];//wqcore
		uint32 jntupo, jnjuexing, jnpeiyang;
