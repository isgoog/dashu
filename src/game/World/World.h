...
enum WorldIntConfigs
{
	...
	CONFIG_BATTLEGROUND_DAMAGE_LIMIT,
	CONFIG_BATTLEGROUND_TREAT_LIMIT,
	//wqcore
	LOGIN_CHANGE_FACTION_JF,
	LOGIN_CHANGE_RACE_JF,
	LOGIN_CUSTOMIZE_JF,
	LOGIN_RENAME_JF,
	ZY_XUEXI_JF,
	ZY_TISHENG_JF,
	CONFIG_AHSL_JF_ID,
	CORE_JF_ID,
	CORE_AUTOGIVERITEM_ID,
	CORE_SUOYAOITEM_ID,
	CORE_AUTOGIVERITEM_ID_COUNT,
	CORE_AUTOGIVERHONOR_COUNT1,
	CORE_AUTOGIVERHONOR_COUNT2,
	ZY_HUANHUA_JF,
	ZY_HUANHUA_ITEM_ID,
	CORE_GOLD_ID,
	CORE_BAOSHI_ID,
	CORE_DYH_ID,
	CORE_ASITEM_ID,
	CORE_ASITEM_ID_COUNT,
	MINJIE_MINJIE,
	MINJIE_QITA,
	MINJIE_MINJIE_MINJIE,
	BAOJI_BAOJI,
	RAID_NAXXBUFF,
	RAID_ULDBUFF,
	RAID_TOCBUFF,
...
class World
{
    public:
		...
		void ResetSendBoxText();
		void ResetSendBoxTextAlx();
		void ResetSendBoxTextFb();
		void ResetSendBoxTextAs();
		void ResetSendBoxTextDyh();
		void ResetSendBoxTextHd1();
		void ResetSendBoxTextHd2();
		void ResetSendBoxTextHd3();
		void ResetSendBoxTextHd4();
		void ResetSendBoxTextHd5();
		void ResetSendBoxTextHd6();
		void ResetSendBoxTextHd7();
		void ResetSendBoxTextHd8();
		void ResetSendBoxTextHd120();
		void ResetSendBoxTextHd123();
		void ResetSendBoxTextHd124();
		bool START_BONUS_BG;
		bool START_BONUS_WORLD;
		uint32 START_BONUS_BG_POINT;
		uint32 START_BONUS_BG_POINT_KILL;
		uint32 START_BONUS_BG_POINT_I;
		uint32 START_BONUS_BG_POINT_KILL_I;
		bool START_BONUS_BG_KAISHI;
		bool START_BONUS_BG_KAISHI_ALX;
		bool START_BONUS_BG_KAISHI_FB;
		bool START_BONUS_BG_KAISHI_AS;
		bool START_BONUS_BG_I;
		void ResetMeiri();
		void ResetMeirishuaxin();
		void ResetHuoli();
		void ResetGiverTime();//wqcoreÅÝµã
    ...
    private:
        ...
        time_t m_startTime;
        time_t m_gameTime;
		time_t m_NextGiverTime;//wqcore ÅÝµã
